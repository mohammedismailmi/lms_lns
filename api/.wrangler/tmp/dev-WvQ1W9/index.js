...
// .wrangler/tmp/bundle-mCrxYw/checked-fetch.js
...
var requestSizeLimit = createMiddleware(async (c, next) => {
...
var ping_default = app2;

// src/index.ts
var app3 = new Hono2();
app3.use("*", corsMiddleware);
app3.use("*", requestSizeLimit);
app3.use("*", tenantMiddleware);
app3.route("/health", health_default);
app3.route("/api/ping", ping_default);
app3.notFound((c) => {
